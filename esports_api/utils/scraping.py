"""Utility functions that can help with scraping data from the external esports sites
...
class XpathParser:
    ...
    def get_element(self, xpath: str) -> html.HtmlElement:
    ...
    def get_img(self, xpath: str) -> str | None:
        ...
        Returns:
            str | None: the data contained in the `src` tag of the `HtmlElement` at the XPATH, or None if the src tag cannot be located.
        """
        return self.get_element(xpath).get("src", "").strip() or None

    def get_href(self, xpath: str) -> str | None:
        ...
        Returns:
            str | None: the data contained in the `href` tag of the `HtmlElement` at the XPATH, or None if the href tag cannot be located.
        """
    ...
    def get_text(self, xpath: str) -> str | None:
        ...
        Returns:
            str: The inner text of the element, or None if no element or text could be found
        """
